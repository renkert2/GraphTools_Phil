classdef HeatExchanger < Component
    ...
    methods (Access = protected)
        function g = DefineGraph(obj)
            ...
            % Define Edges
            Edge(1) = GraphEdge_Internal('PowerFlow',P(1),'Input',1,'Port',1,'Coefficient',obj.cp_f1);
            Edge(2) = GraphEdge_Internal('PowerFlow',P(1),'Input',1,'Port',2,'Coefficient',obj.cp_f1);
            Edge(3) = GraphEdge_Internal('PowerFlow',P(1),'Input',2,'Port',3,'Coefficient',obj.cp_f2);
            Edge(4) = GraphEdge_Internal('PowerFlow',P(1),'Input',2,'Port',4,'Coefficient',obj.cp_f2);
            Edge(5) = GraphEdge_Internal('PowerFlow',[P(2); P(3)],'Coefficient',[obj.HTC -obj.HTC]);
