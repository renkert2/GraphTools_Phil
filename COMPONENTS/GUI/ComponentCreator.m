classdef ComponentCreator < matlab.apps.AppBase
...
%             app.PropertiesPanel.Units = 'normalized';

            % Create GridLayout
            app.GridLayout = uiexpandinggridlayout(app.PropertiesPanel);
