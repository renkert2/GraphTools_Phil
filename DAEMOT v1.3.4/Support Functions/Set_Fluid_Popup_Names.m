...
% This function adds all the available fluids in 'Fluids.mat' to the "Fluid Type" popup list.  
% For more info, see: http://www.mathworks.com/matlabcentral/answers/82930-dynamically-populating-mask-parameter-popup-list

% Note that the options for ALL POPUPS in the mask will be set to the list of fluids.  
