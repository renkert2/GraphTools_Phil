% This function is used in conjunction with the CoolProp open-source code 
% (http://www.coolprop.org/) to generate property tables for humid 
% air and add them to AirProp.mat

% The CoolProp MATLAB code must be downloaded and located on 
% the MATLAB path for this to run.

% Created by Herschel Pangborn, University of Illinois at Urbana-Champaign
% March 2015
