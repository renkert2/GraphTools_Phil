...
Edge(2) = GraphEdge_Internal('PowerFlow',P(1),'Input',I(1),'Port',2,'Coefficient',cp_f1,'TailVertex',Vertex(E(2,1)),'HeadVertex',Vertex(E(2,2)));
...
Edge(5) = GraphEdge_Internal('PowerFlow',[P(2); P(3)],'Coefficient',[HTC -HTC],'TailVertex',Vertex(E(5,1)),'HeadVertex',Vertex(E(5,2)));
